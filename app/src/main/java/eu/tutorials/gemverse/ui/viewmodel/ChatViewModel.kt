package eu.tutorials.gemverse.ui.viewmodel
...
import eu.tutorials.gemverse.data.model.ChatSessionModel
import eu.tutorials.gemverse.data.model.MessageModel
import eu.tutorials.gemverse.data.utils.Constants
...
class ChatViewModel : ViewModel() {
    ...
    val generativeModel: GenerativeModel = GenerativeModel(
        ...
        generationConfig = GenerationConfig.Companion.builder().build()
    )
...
//            }
        ...
        db.collection("chats")
            .document(email)
            .collection("sessions")
            .orderBy("timestamp", Query.Direction.DESCENDING) // 👈 sabse latest pehle
